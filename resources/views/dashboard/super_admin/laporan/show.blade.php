...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('super-admin.laporan.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                Kembali
            </a>
            <div>
                <a href="{{ route('super-admin.laporan.edit', $laporan) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">
                    Edit
                </a>
                <form action="{{ route('super-admin.laporan.destroy', $laporan) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus laporan ini? Tindakan ini tidak dapat dibatalkan.');">
                    @csrf
                    @method('DELETE')
