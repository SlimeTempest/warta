...
<head>
    ...
    <title>Registrasi - Warta.id</title>
...
<body style="background: #f8f9fa; min-height: 100vh; display: flex; align-items: center; justify-content: center; font-family: 'Jost', sans-serif;">
    <div class="max-w-md w-full bg-white" style="padding: 50px; border: 1px solid #e9ecef;">
        <div class="text-center mb-8">
            ...
            <p style="font-family: 'Jost', sans-serif; color: #8f8f8f; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">Daftar Akun Baru</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div style="margin-bottom: 25px;">
                <label for="name" style="display: block; font-family: 'Jost', sans-serif; font-weight: 500; color: #212529; font-size: 14px; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.5px;">
                    Nama Lengkap
                </label>
                <input 
                    type="text" 
            ...
            <div style="margin-bottom: 25px;">
                <label for="password_confirmation" style="display: block; font-family: 'Jost', sans-serif; font-weight: 500; color: #212529; font-size: 14px; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.5px;">
                    Konfirmasi Password
                </label>
                <div style="position: relative;">
                    <input 
        ...
        <div style="margin-top: 30px; text-align: center; font-family: 'Jost', sans-serif; font-size: 14px; color: #8f8f8f;">
            <p>
                Sudah punya akun? 
                <a href="{{ route('login') }}" style="color: #212529; text-decoration: none; font-weight: 500; transition: color 0.3s ease;" onmouseover="this.style.color='#0d6efd'" onmouseout="this.style.color='#212529'">Login di sini</a>
            </p>
        </div>
    </div>
